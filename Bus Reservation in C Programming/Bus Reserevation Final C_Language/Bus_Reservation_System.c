...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Volcano  Express","Belt Express","Horizon Express","Blue bus Express","South port Express","Rajkot Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
   printf("====================================== WELCOME TO BUS TICKET AND RESERVATION SYSTEM ======================================\n\n\n");
    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword); 
		if(strcmp(uname,"Chaste")==0 && strcmp(pword,"pass")==0)
	{
